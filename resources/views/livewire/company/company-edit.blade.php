    ...
    <section class="bg-white p-3 shadow-sm">
        <form wire:submit="update" enctype="multipart/form-data">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('company_name') is-invalid @enderror" id="company_name"
                        wire:model="company_name" autofocus>
                    @error('company_name')
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="file" class="form-control @error('company_logo') is-invalid @enderror" id="company_logo"
                        wire:model="company_logo" autofocus>
                    @error('company_logo')
                        <small class="invalid-feedback">{{ $message }}</small>
                    @enderror
                    @if ($company_logo)
