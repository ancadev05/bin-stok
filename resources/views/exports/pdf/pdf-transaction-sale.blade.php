...
<head>
    ...
    <title>Penjualan-{{ $sale->sale_code }}</title>
...
<body>
    ...
    <div class="tombol">
        ...
        <div class="d-flex justify-content-end">
            <a wire:navigate href="{{ route('sale') }}" class="btn btn-sm btn-secondary me-2"><i class="fas fa-reply">
                </i>
                Kembali</a>
            <a href="{{ route('sale') }}" class="btn btn-sm btn-info"><i class="fas fa-print"> </i> Cetak</a>
            <button onclick="deleteData({{ $sale->id }}, '{{ $sale->sale_code }}')"
